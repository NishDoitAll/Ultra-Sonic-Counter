...
# 18 "C:\Program Files\Microchip\xc8\v2.45\pic\include\xc.h"
...
# 7 "C:\Program Files\Microchip\xc8\v2.45\pic\include\builtins.h"
...
# 52 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC16Fxxx_DFP/1.6.156/xc8\pic\include\proc\pic16f690.h"
...
if(dist <= minthreshold )
{
lowcount = 0;highcount = 0;count=8;
T0IF = 0;
T0CS = 0;
while(1)
{
...
else{lowcount = 0;highcount = 0;count=8;goto reset;}
}
}
}
else if(RC3 == 1)
...
{
dist = calc_dist();
if(dist <= minthreshold){highcount++;count++;}
if(count == 0){T0CS = 1;T0IF = 0;}
if(dist > minthreshold && dist <= threshold){lowcount++;count--;}
if(count == 0){T0CS = 1;T0IF = 0;}
T0IF = 0;
}
